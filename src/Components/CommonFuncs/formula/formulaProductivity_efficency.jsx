export const productivity_efficiency_productivityPercentagePlannedForUseOfY1 = (props, userInputData) => {
  let newArr = userInputData.productivity.efficiency.efficiencyLevers.map((ele) => {
  ...
  userInputData.productivity.efficiency.efficiencyLevers = newArr;
}
export const efficiency_isScopeApplicablity = (props, userInputData) => {
    let newArr = userInputData.productivity.efficiency.efficiencyLevers.map((ele) => {
      let selctionkey = ele.clientMaturityLevelSelectionKey;
      if (!ele.isScopeApplicable) {
