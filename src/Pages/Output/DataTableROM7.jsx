                ...
                >
                    ...
                    <Table {...getTableProps()}>
                        ...
                        <TableBody>
                            ...
                            {props.title == 'Application Operations' ?
                                <>
                                    {outputYearOneROMCostSecurityArray.map(tds => {
                                        ...
                                        else if (tds[0] === 'costAIOpsObservability' || tds[0] === 'costAIOpsARM' || tds[0] === 'costAnnual') {
                                            return (
                                                <TableRow>
