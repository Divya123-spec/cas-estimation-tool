...
function Y6ProductivityProductivityCalculation({ title, id }) {
    ...
    y1PCTableData[0].data[0]['L1.5'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.l1|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.l1
    y1PCTableData[0].data[0]['L2'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.l2|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.l2
    y1PCTableData[0].data[0]['L3'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.l3|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.l3
    y1PCTableData[0].data[0]['L4'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.l4|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.l4
    y1PCTableData[0].data[0]['Minor Enh'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.minEnh|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.minEnh
    y1PCTableData[0].data[0]['Testing'] = pcData.baseLineEffortsDetailsFromY6?.baseLineEffortsByLevels.testing|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.testing
    y1PCTableData[0].data[0]['Total'] = pcData.baseLineEffortsDetailsFromY6?.sumOfBaseLineEfforts|| pcData.efficiencyCalculation.productivityCalculationY1.effortsRemainingAfterProductivityByLevels.sumOfEffortsRemainingAfterProductivity

    prepareData(y1PCTableData[0], pcData.devSecOpsCalculation.productivityCalculationY6);
    prepareData(y1PCTableData[1], pcData.automationCalculation.productivityCalculationY6);
    prepareData(y1PCTableData[2], pcData.cloudCalculation.productivityCalculationY6);
    prepareData(y1PCTableData[3], pcData.testingCalculation.productivityCalculationY6);
    prepareData(y1PCTableData[4], pcData.efficiencyCalculation.productivityCalculationY6);
...
export default Y6ProductivityProductivityCalculation
