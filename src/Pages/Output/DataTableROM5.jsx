                            ...
                            {props.title == 'Security (Used for On-Premises solutions only)' ||
                                ...
                                <>
                                    {outputYearOneROMCostSecurityArray.map(tds => {
                                            ...
                                            return (
                                                <TableRow>
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].simple.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.lowRange.annualRecurringCostInUSD)}` : ''}
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].simple.highRange.annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.highRange.annualRecurringCostInUSD)}` : ''}
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].medium.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.lowRange.annualRecurringCostInUSD)}` : ''}
                                                    </TableCell>
                                                    <TableCell>
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].medium.highRange.annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.highRange.annualRecurringCostInUSD)}` : ''}
                                                    </TableCell>
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].complex.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].complex.lowRange.annualRecurringCostInUSD)}` : ''}
                                                    </TableCell>
                                                    <TableCell>
                                                    ...
                                                    <TableCell className="BorderClass" >
                                                        ...
                                                        {typeof (tds[1].annualRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].annualRecurringCostInUSD)}` : ''}
                                        ...
                                        //             <TableCell className="BorderClass2"  > {englishValue(tds[0])}</TableCell>
                                        //             <TableCell >
                                        //             {typeof(tds[1].simple.lowRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].simple.lowRange.oneTimeCostInUSD}` : ''}

                                        //               </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].simple.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `$${tds[1].simple.lowRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell >
                                        //             {typeof(tds[1].simple.highRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].simple.highRange.oneTimeCostInUSD}` : ''}

                                        //                 </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].simple.highRange.annualRecurringCostInUSD ) !== 'undefined'? `$${tds[1].simple.highRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell>

                                        //             {typeof(tds[1].medium.lowRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].medium.lowRange.oneTimeCostInUSD}` : ''}

                                        //               </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].medium.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `$${tds[1].medium.lowRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell>
                                        //             {typeof(tds[1].medium.highRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].medium.highRange.oneTimeCostInUSD}` : ''}

                                        //               </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].medium.highRange.annualRecurringCostInUSD ) !== 'undefined'? `$${tds[1].medium.highRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell>

                                        //             {typeof(tds[1].complex.lowRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].complex.lowRange.oneTimeCostInUSD}` : ''}

                                        //               </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].complex.lowRange.annualRecurringCostInUSD) !== 'undefined' ? `$${tds[1].complex.lowRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell>
                                        //             {typeof(tds[1].complex.highRange.oneTimeCostInUSD) !== 'undefined' ? `$${tds[1].complex.highRange.oneTimeCostInUSD}` : ''}


                                        //                </TableCell>
                                        //             <TableCell className="BorderClass" >{typeof(tds[1].complex.highRange.annualRecurringCostInUSD ) !== 'undefined'? `$${tds[1].complex.highRange.annualRecurringCostInUSD}` : ''}</TableCell>
                                        //             <TableCell className="BorderClass" >
                                        //             {typeof(tds[1].totalOfLowRangeInUSD) !== 'undefined' ? `$${tds[1].totalOfLowRangeInUSD}` : ''}

                                        //                </TableCell>
                                        //             <TableCell className="BorderClass" >
                                        //             {typeof(tds[1].totalOfHighRangeInUSD) !== 'undefined' ? `$${tds[1].totalOfHighRangeInUSD}` : ''}

                                        //               </TableCell>
                                        //             <TableCell >
                                        //             {typeof(tds[1].averageOfOneTimeCostInUSD) !== 'undefined' ? `$${tds[1].averageOfOneTimeCostInUSD}` : ''}

                                        //              </TableCell>
                                        //             <TableCell >{tds[1].averageOfOneTimeCostInUSD ? `$${tds[1].averageOfOneTimeCostInUSD}` : ''}</TableCell>
                                        //         </TableRow>
                                        //     )
                                        // }
                                            ...
                                            return (
                                                <TableRow>
                                                    ...
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].simple.lowRange.fteMRC) !== 'undefined' ? `${tds[1].simple.lowRange.fteMRC}` : ''}

                                                    </TableCell>
                                                    <TableCell ></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].simple.highRange.fteMRC) !== 'undefined' ? `${tds[1].simple.highRange.fteMRC}` : ''}
                                                    ...
                                                    <TableCell className='BorderClass'>
                                                        ...
                                                        {typeof (tds[1].medium.lowRange.fteMRC) !== 'undefined' ? `${tds[1].medium.lowRange.fteMRC}` : ''}
                                                    </TableCell>
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>

                                                        {typeof (tds[1].medium.highRange.fteMRC) !== 'undefined' ? `${tds[1].medium.highRange.fteMRC}` : ''}
                                                    </TableCell>

                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>

                                                        {typeof (tds[1].complex.lowRange.fteMRC) !== 'undefined' ? `${tds[1].complex.lowRange.fteMRC}` : ''}
                                                    </TableCell>
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].complex.highRange.fteMRC) !== 'undefined' ? `${tds[1].complex.highRange.fteMRC}` : ''}
                                                    </TableCell>

                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].totalOfLowRange) !== 'undefined' ? `${tds[1].totalOfLowRange}` : ''}

                                                    </TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].totalOfHighRange) !== 'undefined' ? `${tds[1].totalOfHighRange}` : ''}
                                            ...
                                            return (
                                                <TableRow>
                                                    ...
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].simple.lowRange.bandMixMRC) !== 'undefined' ? `${tds[1].simple.lowRange.bandMixMRC}` : ''}

                                                    </TableCell>
                                                    <TableCell ></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].simple.highRange.bandMixMRC) !== 'undefined' ? `${tds[1].simple.highRange.bandMixMRC}` : ''}

                                                    </TableCell>

                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].medium.lowRange.bandMixMRC) !== 'undefined' ? `${tds[1].medium.lowRange.bandMixMRC}` : ''}

                                                    </TableCell>
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].medium.highRange.bandMixMRC) !== 'undefined' ? `${tds[1].medium.highRange.bandMixMRC}` : ''}

                                                    </TableCell>

                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].complex.lowRange.bandMixMRC) !== 'undefined' ? `${tds[1].complex.lowRange.bandMixMRC}` : ''}

                                                    </TableCell>
                                                    <TableCell></TableCell>
                                                    <TableCell className='BorderClass'>
                                                        {typeof (tds[1].complex.highRange.bandMixMRC) !== 'undefined' ? `${tds[1].complex.highRange.bandMixMRC}` : ''}
                                        ...
                                        else if (tds[0] === 'costProductivityFPL' || tds[0] === 'costProductivityAQL' || tds[0] === 'costProductivityAgileCoach') {
                                            return (
                                                <TableRow>
                                                    <TableCell className='BorderClass3 RowColor'> {englishValue(tds[0])}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].simple.lowRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.lowRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].simple.lowRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.lowRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].simple.highRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.highRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].simple.highRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.highRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].medium.lowRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.lowRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].medium.lowRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.lowRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].medium.highRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.highRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].medium.highRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].medium.highRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].complex.lowRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].complex.lowRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].complex.lowRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].complex.lowRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].complex.highRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].complex.highRange.oneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].complex.highRange.monthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].complex.highRange.monthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor'>{typeof (tds[1].totalOfLowRangeInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].totalOfLowRangeInUSD)}` : ''}</TableCell>
                                                    <TableCell className='BorderClass RowColor' >{typeof (tds[1].totalOfHighRangeInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].totalOfHighRangeInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor'>{typeof (tds[1].averageOfOneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].averageOfOneTimeCostInUSD)}` : ''}</TableCell>
                                                    <TableCell className='RowColor' >{typeof (tds[1].averageOfMonthlyRecurringCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].averageOfMonthlyRecurringCostInUSD)}` : ''}</TableCell>
                                                </TableRow>
                                            )
                                        }

                                        else if (tds[0] === 'transitionNonLabourCosts' ) {
                                            return (
                                                <TableRow>
                                        ...
                                        else if ( tds[0] === 'transitionLabourCosts') {
                                            return (
                                                <TableRow>
                                                    <TableCell className='BorderClass2 RowColor'>{`TRANSITION LABOUR cost for ${props.usertransitionDeal} months` }</TableCell>
                                            ...
                                            return (
                                                <TableRow>
                                                    ...
                                                    <TableCell >
                                                        ...
                                                        {typeof (tds[1].simple.lowRange.oneTimeCostInUSD) !== 'undefined' ? `${currencyCoverter(tds[1].simple.lowRange.oneTimeCostInUSD)}` : ''}</TableCell>
