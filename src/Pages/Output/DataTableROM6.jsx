...
const DataTableROM6 = (props) => {
    ...
    return (
        <DataTable rows={[]} headers={props.headerMain_3}>
            {({ rows, headers, getHeaderProps, getTableProps }) => (
                ...
                >
                    ...
                    <Table {...getTableProps()}>
                        <TableHead>
                            <TableRow>
                                {props.headerMain_3.map((header) => {
                                    if (header !== 'Application Complexity' && header !== 'TOTALS') {
                                        return (
                            ...
                            <TableRow>
                                {props.monthlyheader_4.map((header) => {
                            ...
                            <TableRow>
                                {props.monthlyheader_5.map((header) => {
                                    if (header === 'OTC') {
                                        return (
                                            ...
                                            if (tds[0] === 'totalCostYearly') {
                                                return (
                                                    <TableRow>
                                                        ...
                                                        <TableCell className="tableBold" >{currencyCoverter(tds[1].simple.lowRange.oneTimeCostInUS)}</TableCell>
                                                        <TableCell className="tableBold BorderClass" >{currencyCoverter(tds[1].simple.lowRange.recurringCostInUSD)}</TableCell>
                                                        <TableCell className="tableBold" >{currencyCoverter(tds[1].simple.highRange.oneTimeCostInUSD)}</TableCell>
                                                        <TableCell className="tableBold BorderClass" >{currencyCoverter(tds[1].simple.highRange.recurringCostInUSD)}</TableCell>
                                                        ...
                                                        <TableCell className="tableBold " >{currencyCoverter(tds[1].avgOfAvgOfLowAndHighRangesInUSD)}</TableCell>
                                                        <TableCell className="tableBold BorderClass">{currencyCoverter(tds[1].avgOfAvgOfLowAndHighRangesAndAvgOfHighRangeInUSD)}</TableCell>
                                                        <TableCell >${tds[1].distributionHighPercentage}%`</TableCell>
                                                    </TableRow>
                                                )
                                            }
                                                ...
                                                return (
                                                    <TableRow> 
                                                        ...
                                                        <TableCell >{currencyCoverter(tds[1].avgOfAvgOfLowAndHighRangesInUSD)}</TableCell>
                                                        <TableCell className="BorderClass">{currencyCoverter(tds[1].avgOfAvgOfLowAndHighRangesAndAvgOfHighRangeInUSD)}</TableCell>
                                                        <TableCell >{`${tds[1].distributionHighPercentage}%`}</TableCell>
